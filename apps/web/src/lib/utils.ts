import { CommandId, MessageId, ProjectId, SubThreadId, ThreadId } from "@t3tools/contracts";
...
export const newSubThreadId = (): SubThreadId => SubThreadId.makeUnsafe(randomUUID());
