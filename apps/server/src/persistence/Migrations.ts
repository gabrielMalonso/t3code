...
import Migration0026 from "./Migrations/025_CleanupInvalidProjectionPendingApprovals.ts";
import Migration0027 from "./Migrations/027_ProjectionThreadsBootstrapPhase.ts";
...
import Migration0031 from "./Migrations/029_ProjectionThreadDetailOrderingIndexes.ts";
import Migration0032 from "./Migrations/030_ProjectionThreadShellArchiveIndexes.ts";
...
import Migration0037 from "./Migrations/032_AuthPairingProofKeyThumbprint.ts";
...
export const migrationEntries = [
  ...
  [27, "ProjectionThreadsBootstrapPhase", Migration0027],
  ...
  [31, "ProjectionThreadDetailOrderingIndexes", Migration0031],
  [32, "ProjectionThreadShellArchiveIndexes", Migration0032],
  ...
  [37, "AuthPairingProofKeyThumbprint", Migration0037],
] as const;
