  ...
  threads: [
    {
      ...
      updatedAt: now,
      deletedAt: null,
      activeSubThreadId: SubThreadId.makeUnsafe("sub-1"),
      subThreads: [
        {
          id: SubThreadId.makeUnsafe("sub-1"),
    ...
    },
    {
      ...
      updatedAt: now,
      deletedAt: null,
      activeSubThreadId: SubThreadId.makeUnsafe("sub-2"),
      subThreads: [
        {
          id: SubThreadId.makeUnsafe("sub-2"),
