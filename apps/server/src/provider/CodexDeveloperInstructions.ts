...
const appendPreviewMcpInstructions = (
  instructions: string,
  previewMcpEnabled: boolean | undefined,
): string =>
...
export const makeCodexPlanModeDeveloperInstructions = (input?: {
  readonly previewMcpEnabled?: boolean;
}): string =>
  appendPreviewMcpInstructions(
    CODEX_PLAN_MODE_DEVELOPER_INSTRUCTIONS_BASE,
    input?.previewMcpEnabled,
  );

export const makeCodexDefaultModeDeveloperInstructions = (input?: {
  readonly previewMcpEnabled?: boolean;
}): string =>
  appendPreviewMcpInstructions(
...
export const CODEX_PLAN_MODE_DEVELOPER_INSTRUCTIONS = makeCodexPlanModeDeveloperInstructions();
