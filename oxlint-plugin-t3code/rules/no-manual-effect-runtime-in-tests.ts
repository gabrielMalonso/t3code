...
const LEGACY_BASELINE = new Map<string, number>([
  ...
  ["apps/server/src/externalComposerIntake.test.ts", 5],
  ...
  ["apps/server/src/orchestration/Layers/ThreadLoopScheduler.test.ts", 47],
  ["apps/server/src/orchestration/Layers/ThreadDeletionReactor.test.ts", 2],
  ["apps/server/src/orchestration/projector.test.ts", 23],
