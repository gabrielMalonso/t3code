...
function ComposerPromptEditorInner({
  ...
  const snapshotRef = useRef({
    ...
    expandedSelectionStart: expandCollapsedComposerCursor(value, initialCursor),
    expandedSelectionEnd: expandCollapsedComposerCursor(value, initialCursor),
  ...
  const readSnapshot = useCallback((): {
    ...
    editor.getEditorState().read(() => {
      ...
      const expandedSelectionRange = getSelectionRangeForExpandedComposerOffsets($getSelection());
      const expandedSelectionStart = expandedSelectionRange?.start ?? nextExpandedCursor;
      const expandedSelectionEnd = expandedSelectionRange?.end ?? nextExpandedCursor;
      const terminalContextIds = collectTerminalContextIds($getRoot());
      snapshot = {
        value: nextValue,
        cursor: nextCursor,
        expandedCursor: nextExpandedCursor,
        selectionStart: collapseExpandedComposerCursor(nextValue, expandedSelectionStart),
  ...
  const handleEditorChange = useCallback((editorState: EditorState) => {
    editorState.read(() => {
      ...
      snapshotRef.current = {
        ...
        expandedSelectionStart: nextExpandedCursor,
        expandedSelectionEnd: nextExpandedCursor,
        terminalContextIds,
      };
