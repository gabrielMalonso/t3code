  ...
  return (
    <>
      ...
      <ComposerPrimaryActions
        ...
        isResolvingFileReferences={props.isResolvingFileReferences}
...
export interface ChatComposerProps {
  ...
  composerFileReferencesRef: React.RefObject<ComposerFileReference[]>;
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  }, [composerFileReferences, composerFileReferencesRef]);
  ...
  // ------------------------------------------------------------------
  // Custom composer file/image handling
  // ------------------------------------------------------------------
  const removeComposerImage = customExtension.removeComposerImage;
  const onComposerDragEnter = customExtension.onComposerDragEnter;
  const onComposerDragOver = customExtension.onComposerDragOver;
  const onComposerDragLeave = customExtension.onComposerDragLeave;
  const onComposerDrop = customExtension.onComposerDrop;
      ...
      >
        <div
          ...
          className={cn(
            ...
            customExtension.isDragOverComposer ? "border-primary/70 bg-accent/30" : "border-border",
                ...
                {isComposerFooterCompact ? (
                  <>
                    <CompactComposerControlsMenu
                      ...
                      onPointNShootBridgeEnabledChange={onPointNShootBridgeEnabledChange}
