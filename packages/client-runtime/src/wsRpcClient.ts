...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly reconnectMcp: RpcUnaryMethod<typeof WS_METHODS.serverReconnectMcp>;
...
export function createWsRpcClient(
  ...
  return {
    ...
    server: {
      ...
      reconnectMcp: (input) =>
        transport.request((client) => client[WS_METHODS.serverReconnectMcp](input)),
      ...
      subscribeExternalComposerIntake: (input, listener, options) =>
        transport.subscribe(
          ...
          listener,
          subscriptionOptions(options, WS_METHODS.subscribeExternalComposerIntake),
        ),
    },
    cloud: {
