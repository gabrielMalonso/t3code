...
export const CLAUDE_THINKING_MODES = ["enabled", "disabled", "adaptive"] as const;
export type ClaudeThinkingMode = (typeof CLAUDE_THINKING_MODES)[number];

export const ClaudeCodeModelOptions = Schema.Struct({
  thinking: Schema.optional(Schema.Literals(CLAUDE_THINKING_MODES)),
});
